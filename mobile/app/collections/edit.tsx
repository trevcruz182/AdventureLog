...
export default function EditCollectionScreen() {
    ...
    function cancelEditing() {
        ...
        Alert.alert("Discard your changes?", "Your collection edits will not been saved.", [
            {
                text: "Keep editing",
                style: "cancel"
            },
    ...
    if(collectionQuery.isError || !collection || !collectionId) {
        return(
            <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
                <View style={styles.centerState}>
                    ...
                    <Text style={styles.stateDescription}>
                        AdventureLog could not prepare this collection for editing.
                    </Text>
            ...
            >
                ...
                <View style={styles.footer}>
                    <Pressable
                        ...
                        onPress={handleSubmit(submitCollectionUpdate)}
                        style={({pressed}) => [styles.saveButton, pressed && !isSaving && styles.pressed, (isSaving || !isDirty) && styles.disabled]}
                    >
                        {isSaving ? (
